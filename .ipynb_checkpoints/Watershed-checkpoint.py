...
img_name = "05.tif"
img_location = "/home/devesh/cell-segmentation/images/"
img = cv2.imread(os.path.join(img_location,img_name))
#Extract only blue channel as DAPI / nuclear (blue) staining is the best
#channel to perform cell count.
cells=img[:,:,2]  #Green channel. Image equivalent to grey image.
